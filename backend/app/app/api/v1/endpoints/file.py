...
from app.schemas.file_schema import IFileRead
...
async def upload_files(
...
) -> IPostResponseBase[list[IFileRead]]:
    """
    Uploads images
    """
    ...
    result = await crud.file.upload_files(
        file_list=files, account_id=account_id, db_session=db_session, to_db = to_db
    )
